...
[CreateAssetMenu(fileName = "PlayerStatModifierEffect", menuName = "Gameplay/Pacts/Player Stat Modifier Effect")]
public class StatModifierEffect : PactEffect
{
    ...
    private bool HasRequiredTags(StatQuery query)
    {
